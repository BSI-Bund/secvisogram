...
function View({
  ...
  return (
    <div className="mx-auto w-full h-screen">
      <div className="px-3 py-2 flex justify-between items-center w-full h-14 fixed left-0 top-0 z-10 bg-white shadow">
      ...
      <div className="pt-1 bg-gray-200 flex mt-14">
        <button
          className={
            'ml-3 px-2 pb-2 pt-1 ' +
