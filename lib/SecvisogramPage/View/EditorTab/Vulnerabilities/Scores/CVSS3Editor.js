...
import CVSSMetrics from './CVSS3Editor/CVSSMetrics'
...
export default function CVSSV3Editor(props) {
  const cvssVector = new CVSSMetrics(/** @type {{}} */ (props.value))
        ...
        const cvssV3Props = (/** @type {string} */ key) => {
          return {
            ...
            onChange(/** @type {string} */ v) {
              ...
              props.onUpdate(objectProps('vectorString').dataPath, {
                $set: cvssVector.set(key, v).vectorString,
              })
            },
            onDelete() {
              if (key === 'vectorString') return
              props.onUpdate(objectProps('vectorString').dataPath, {
                $set: cvssVector.remove(key).vectorString,
              })
            },
          }
        }
            ...
            <TextAttribute
              ...
              onBlur={(e) => {
                ...
                props.onUpdate(props.dataPath, {
                  $merge: {
                    ...(updatedCVSSMetrics.vectorString
                      ? updatedCVSSMetrics.data
                      : {}),
                    vectorString:
                      updatedCVSSMetrics.vectorString ||
