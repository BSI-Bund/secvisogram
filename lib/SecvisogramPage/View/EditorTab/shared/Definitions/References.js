        ...
        >
          {(referenceProps) => (
            <>
              <TextAreaAttribute
                {...referenceProps}
                dataPath={`${referenceProps.dataPath}/summary`}
                value={referenceProps.value.summary}
                label="Summary of the reference"
                description="Indicates what this reference refers to."
              />
              <EnumAttribute
                {...referenceProps}
                dataPath={`${referenceProps.dataPath}/type`}
                value={referenceProps.value.type}
              ...
              <TextAttribute
                {...referenceProps}
                dataPath={`${referenceProps.dataPath}/url`}
                value={referenceProps.value.url}
