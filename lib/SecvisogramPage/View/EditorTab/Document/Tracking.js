      ...
      {tracking ? (
        <>
          <TextAttribute
            ...
            value={tracking.id}
            onUpdate={(data) => {
              onUpdate({ document: { tracking: { id: data } } })
            }}
          />
          <TextAttribute
            label="Version"
            ...
            onUpdate={(data) => {
              onUpdate({ document: { tracking: { version: data } } })
            }}
          />
          <EnumAttribute
            ...
            onUpdate={(data) => {
              onUpdate({ document: { tracking: { status: data } } })
            }}
          />
          <DateAttribute
            ...
            onUpdate={(data) => {
              onUpdate({
                document: { tracking: { initial_release_date: data } },
              })
            }}
          />
          <DateAttribute
            ...
            onUpdate={(data) => {
              onUpdate({
                document: { tracking: { current_release_date: data } },
              })
            }}
          />
          <RevisionHistory
