export default {
  ...
  weaknesses: [
    ...
    {
      id: 'CWE-1243',
      name: 'Exposure of Security-Sensitive Fuse Values During Debug',
      status: 'Incomplete',
    },
    {
      id: 'CWE-1244',
      name: 'Improper Authorization on Physical Debug and Test Interfaces',
      status: 'Incomplete',
    },
    {
      id: 'CWE-1245',
    ...
    {
      id: 'CWE-1263',
      name: 'Insufficient Physical Protection Mechanism',
      status: 'Incomplete',
    },
    {
      id: 'CWE-1264',
    ...
    { id: 'CWE-1267', name: 'Policy Uses Obsolete Encoding', status: 'Draft' },
    {
      id: 'CWE-1268',
      name: 'Agents Included in Control Policy are not Contained in Less-Privileged Policy',
      status: 'Draft',
    },
    {
      id: 'CWE-1269',
    ...
    {
      id: 'CWE-1271',
      name: 'Missing Known Value on Reset for Registers Holding Security Settings',
      status: 'Incomplete',
    },
    {
      id: 'CWE-1272',
    ...
    {
      id: 'CWE-1276',
      name: 'Hardware Block Incorrectly Connected to Larger System',
      status: 'Incomplete',
    },
    { id: 'CWE-1277', name: 'Firmware Not Updateable', status: 'Incomplete' },
    {
      id: 'CWE-1278',
    ...
    {
      id: 'CWE-1282',
      name: 'Assumed-Immutable Data Stored in Writable Memory',
      status: 'Incomplete',
    },
    {
      id: 'CWE-1283',
    ...
    { id: 'CWE-190', name: 'Integer Overflow or Wraparound', status: 'Stable' },
    {
      id: 'CWE-191',
    ...
    { id: 'CWE-20', name: 'Improper Input Validation', status: 'Stable' },
    {
      id: 'CWE-200',
    ...
    { id: 'CWE-203', name: 'Observable Discrepancy', status: 'Incomplete' },
    {
      id: 'CWE-204',
    ...
    {
      id: 'CWE-226',
      name: 'Sensitive Information Uncleared in Resource Before Release for Reuse',
      status: 'Draft',
    },
    {
      id: 'CWE-228',
    ...
    { id: 'CWE-261', name: 'Weak Encoding for Password', status: 'Incomplete' },
    ...
    { id: 'CWE-269', name: 'Improper Privilege Management', status: 'Draft' },
    {
      id: 'CWE-27',
      name: "Path Traversal: 'dir/../../filename'",
      status: 'Draft',
    ...
    { id: 'CWE-295', name: 'Improper Certificate Validation', status: 'Draft' },
    {
      id: 'CWE-296',
    ...
    { id: 'CWE-416', name: 'Use After Free', status: 'Stable' },
    ...
    { id: 'CWE-426', name: 'Untrusted Search Path', status: 'Stable' },
    {
      id: 'CWE-427',
    ...
    { id: 'CWE-476', name: 'NULL Pointer Dereference', status: 'Stable' },
    ...
    { id: 'CWE-489', name: 'Active Debug Code', status: 'Draft' },
    {
      id: 'CWE-49',
    ...
    { id: 'CWE-707', name: 'Improper Neutralization', status: 'Incomplete' },
    {
      id: 'CWE-708',
    ...
    { id: 'CWE-787', name: 'Out-of-bounds Write', status: 'Draft' },
    {
      id: 'CWE-788',
    ...
    { id: 'CWE-798', name: 'Use of Hard-coded Credentials', status: 'Draft' },
    {
      id: 'CWE-799',
