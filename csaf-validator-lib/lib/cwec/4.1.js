export default {
  weaknesses: [
    ...
    { id: 'CWE-1259', name: 'Improper Protection of Security Identifiers' },
    ...
    { id: 'CWE-1263', name: 'Insufficient Physical Protection Mechanism' },
    {
      id: 'CWE-1264',
    ...
    { id: 'CWE-1270', name: 'Generation of Incorrect Security Identifiers' },
    {
      id: 'CWE-1271',
      name: 'Missing Known Value on Reset for Registers Holding Security Settings',
    },
    { id: 'CWE-1272', name: 'Debug/Power State Transitions Leak Information' },
