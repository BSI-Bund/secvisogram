export default {
  weaknesses: [
    ...
    { id: 'CWE-209', name: 'Error Message Information Leak' },
    ...
    { id: 'CWE-636', name: "Not Failing Securely (aka 'Failing Open')" },
    ...
    { id: 'CWE-655', name: 'Failure to Satisfy Psychological Acceptability' },
