export default /** @type {const} */ ({
  "weaknesses": [
    ...
    { "id": "CWE-1059", "name": "Incomplete Documentation" },
    ...
    { "id": "CWE-1240", "name": "Use of a Risky Cryptographic Primitive" },
    {
      "id": "CWE-1241",
    ...
    { "id": "CWE-256", "name": "Unprotected Storage of Credentials" },
    ...
    { "id": "CWE-38", "name": "Path Traversal: 'absolutepathnamehere'" },
