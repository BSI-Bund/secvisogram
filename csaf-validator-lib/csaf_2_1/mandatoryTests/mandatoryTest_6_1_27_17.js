...
/**
 * This implements the mandatory test 6.1.27.17 of the CSAF 2.1 standard.
 *
 * @param {unknown} doc
 */
export function mandatoryTest_6_1_27_17(doc) {
  /*
  ...
  if (
    !validate(doc) ||
    doc.document.category !== 'csaf_withdrawn' ||
    //
  ...
  const reasonTitle = 'Reasoning for Withdrawal'
  ...
  for (const { note, index } of withdrawalNotes) {
