...
| `document.notes_summary[]`                                            | Contains notes of type summary which are specific to the current context.                                                                                                                                                                                       |
| `document.notes_details[]`                                            | Contains notes of type details which are specific to the current context.                                                                                                                                                                                       |
| `document.notes_general[]`                                            | Contains notes of type general which are specific to the current context.                                                                                                                                                                                       |
| `document.notes_description[]`                                        | Contains notes of type description which are specific to the current context.                                                                                                                                                                                   |
| `document.notes_other[]`                                              | Contains notes of type other which are specific to the current context.                                                                                                                                                                                         |
| `document.notes_faq[]`                                                | Contains notes of type faq which are specific to the current context.                                                                                                                                                                                           |
| `document.notes_legal_disclaimer[]`                                   | Contains notes of type legal_disclaimer which are specific to the current context.                                                                                                                                                                              |
| `document.notes_unknown[]`                                            | Contains notes of unknown type which are specific to the current context.                                                                                                                                                                                       |
...
| `vulnerabilities[].remediations_vendor_fix`                           | Remediations of type vendor_fix sorted by date.                                                                                                                                                                                                                 |
| `vulnerabilities[].remediations_mitigation`                           | Remediations of type mitigation sorted by date.                                                                                                                                                                                                                 |
| `vulnerabilities[].remediations_workaround`                           | Remediations of type workaround sorted by date.                                                                                                                                                                                                                 |
| `vulnerabilities[].remediations_none_available`                       | Remediations of type none_available sorted by date.                                                                                                                                                                                                             |
| `vulnerabilities[].remediations_no_fix_planned`                       | Remediations of type no_fix_planned sorted by date.                                                                                                                                                                                                             |
| `vulnerabilities[].remediations_unknown`                              | Remediations of unknown type sorted by date.                                                                                                                                                                                                                    |
| `vulnerabilities[].notes_summary[]`                                   | Contains notes of type summary which are specific to the current context.                                                                                                                                                                                       |
| `vulnerabilities[].notes_details[]`                                   | Contains notes of type details which are specific to the current context.                                                                                                                                                                                       |
| `vulnerabilities[].notes_general[]`                                   | Contains notes of type general which are specific to the current context.                                                                                                                                                                                       |
| `vulnerabilities[].notes_description[]`                               | Contains notes of type description which are specific to the current context.                                                                                                                                                                                   |
| `vulnerabilities[].notes_other[]`                                     | Contains notes of type other which are specific to the current context.                                                                                                                                                                                         |
| `vulnerabilities[].notes_faq[]`                                       | Contains notes of type faq which are specific to the current context.                                                                                                                                                                                           |
| `vulnerabilities[].notes_legal_disclaimer[]`                          | Contains notes of type legal_disclaimer which are specific to the current context.                                                                                                                                                                              |
| `vulnerabilities[].notes_unknown[]`                                   | Contains notes of unknown type which are specific to the current context.                                                                                                                                                                                       |
