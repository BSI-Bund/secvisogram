    ...
    return (
      ...
      >
        ...
        <header className="w-full flex items-center justify-between border-b p-2">
          <h2 className="text-lg">{t('versionSummaryModal.title')}</h2>
          <button
            type="submit"
            name="cancel"
            form={`submit_version-close_form`}
          >
            <svg
              className="w-6 h-6"
              fill="none"
        ...
        <p className="p-4">{t('versionSummaryModal.pleaseProvideSummary')}</p>
        <form
          method="dialog"
        ...
        >
          <div className="p-4">
            ...
            >
              {t('versionSummaryModal.legacyVersion')}
            </label>
            <input
              className="border border-gray-400 py-1 px-2 w-full shadow-inner rounded"
