export default {
  ...
  $defs: {
    ...
    Selection: {
      ...
      required: ['namespace', 'key', 'version', 'values'],
      type: 'object',
    },
  },
  properties: {
    ...
    target_ids: {
      ...
      examples: [['CVE-1900-0000'], ['VU#999999', 'GHSA-0123-4567-89ab']],
      items: {
        type: 'string',
      },
      minItems: 1,
    ...
    decision_point_resources: {
      ...
      examples: [
        [
          ...
          {
            summary:
              'A JSON file containing extension decision points in the x_com.example namespace',
  ...
  required: ['timestamp', 'schemaVersion', 'selections'],
  additionalProperties: false,
}
