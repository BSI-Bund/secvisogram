...
const revisionHistoryV1 = [
  {number: '1.0.1', date: '2022-08-08T12:34:56.789Z', summary: latestRevisionHistorySummary, legacy_version: latestRevisionHistoryLegacyVersion},
  {number: '1.0.0', date: '2022-07-28T14:25:36.475Z', summary: 'not the latest revision history item without legacy version'}
]

const revisionHistoryDraft = [
  {number: '0.0.3', date: '2022-08-08T12:34:56.789Z', summary: 'final draft', legacy_version: '0'},
  {number: '0.0.2', date: '2022-07-28T14:25:36.475Z', summary: 'update to draft'},
  {number: '0.0.1', date: '2022-07-27T08:09:10.123Z', summary: 'initial draft'}
]
  ...
  advisories: [
    {
      ...
      csaf: { document: { title: 'my first document', tracking: { revision_history: revisionHistoryV1, version: '1.0.1' } } },
    },
    {
      ...
      allowedStateChanges: /** @type {const} */ ([]),
      revision: '1-1e6381e13c091b5b0b8b523ce3d412ba',
      csaf: { document: { title: 'my first document', tracking: { revision_history: revisionHistoryDraft, version: '0.0.3' } } },
    },
    {
